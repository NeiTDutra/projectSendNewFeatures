            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="local">
                    ...
                    <div class="login_form_links">
                        ...
                        ?>
                        <p><?php _e("For more information,",'cftp_admin'); ?> 
                            <a href="<?php echo BASE_URI; ?>Manual_documentação_eletronica_01.pdf" target="_blank"><b><?php _e("access the system manual", 'cftp_admin'); ?></b></a>.
                        </p>
                    </div>
                </div>
