 ...
 *
 */
define('SYSTEM_NAME','Terabitia');
define('SYSTEM_URI','https://www.terabitia.org/');
define('SYSTEM_URI_LABEL','ProjectSend on github');
define('DONATIONS_URL','https://www.terabitia.org/donations/');
 ...
 */
define('NEWS_FEED_URI','https://www.terabitia.org/serve/news');

/**
 * Define the Feed from where to take the latest version
 * number.
 */
define('UPDATES_FEED_URI','https://terabitia.org/serve/versions');
