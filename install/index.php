    ...
    <div class="white-box">
        <div class="white-box-interior">
            ...
            ?>
                        ...
                        <p><?php _e('It seems that Manager is already installed here.','cftp_admin'); ?></p>
            ...
            <?php
                    ...
                    ?>
                            <form action="index.php" name="install_form" id="install_form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="base_uri" class="col-sm-4 control-label"><?php _e('Endereço URL','cftp_admin'); ?></label>
                                    <div class="col-sm-8">
